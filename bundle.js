...
/******/ 	var hotCurrentHash = "79f1832f5c3790fec31f"; // eslint-disable-line no-unused-vars
...
(0, _jquery2.default)('.scale-out').each(function (index, element) {
  var delay = parseInt((0, _jquery2.default)(element).attr('data-delay'), 0);
  setTimeout(function () {
    return (0, _jquery2.default)(element).removeClass('scale-out');
  }, delay);
});
...
(0, _jquery2.default)('.scroll-to, nav .side-nav a').click(function (event) {
  (0, _jquery2.default)('html, body').delay(200).animate({
    scrollTop: (0, _jquery2.default)((0, _jquery2.default)(event.currentTarget).attr('href')).offset().top - 64
  }, 1000);
  (0, _jquery2.default)('.button-collapse').sideNav('hide');
  return false;
});
...
(0, _jquery2.default)('header .scrollspy').on('scrollSpy:enter', function () {
  (0, _jquery2.default)('nav').removeClass('white').addClass('transparent');
  (0, _jquery2.default)('nav .color-switch').addClass('text-lighten-5');
}).on('scrollSpy:exit', function () {
  (0, _jquery2.default)('nav').removeClass('transparent').addClass('white');
  (0, _jquery2.default)('nav .color-switch').removeClass('text-lighten-5');
}).scrollSpy();
